...
namespace Generics.Specifications.Extensions {
    /// <summary> Extension methods for the <see cref="IQuery{T}"/> and <see cref="IQuery{TBase, T}"/> interfaces. </summary>
    public static class QueryExtensions {
        ...
        public static IIncludedQuery<TBase, T, TProperty> Include<TBase, T, TProperty>(
            this IQuery<TBase, T> query,
            Expression<Func<T, TProperty>> selector
            ) => new IncludeQuery<TBase, T, TProperty>(query, selector);
        #endregion
